...
const SitUpsTest = () => {
  ...
  const uploadVideo = async () => {
    ...
    try {
      ...
      // Trigger analysis on your backend
      const videoUrl = uploadRes.data.url;
      const analysisRes = await authAxios.post('/api/performance/analyze', { videoUrl, testType: 'Sit Ups' });
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <h1 className="text-4xl font-bold text-gray-800 mb-8">Sit-Ups Assessment</h1>
      <div className="my-8">
