...
const ShuttleRunTest = () => {
    ...
    const uploadVideo = async () => {
        ...
        try {
            ...
            const analysisRes = await authAxios.post('/api/performance/analyze', { videoUrl, testType: 'Shuttle Run' });
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <h1 className="text-4xl font-bold text-gray-800 mb-8">Shuttle Run Assessment</h1>
            <div className="my-8">
